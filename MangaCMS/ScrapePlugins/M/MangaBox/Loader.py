...
class Loader(MangaCMS.ScrapePlugins.RetreivalBase.RetreivalBase):
	...
	def getFile(self, file_data):
		...
		dedupState = MangaCMS.cleaner.processDownload.processDownload(file_data["title"], wholePath, deleteDups=True)
		if dedupState:
