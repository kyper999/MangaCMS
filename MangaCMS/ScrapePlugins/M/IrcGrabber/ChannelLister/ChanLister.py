...
import MangaCMS.ScrapePlugins.M.IrcGrabber.IrcQueueBase
import MangaCMS.ScrapePlugins.M.IrcGrabber.IrcBot



class ListerBot(MangaCMS.ScrapePlugins.M.IrcGrabber.IrcBot.TestBot):
...
class ChannelTriggerLoader(MangaCMS.ScrapePlugins.M.IrcGrabber.IrcQueueBase.IrcQueueBase):
