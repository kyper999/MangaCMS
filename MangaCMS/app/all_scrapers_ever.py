...
all_scrapers = [
		...
		{'dbKey' : "mb",      'name' : "MangaBaby",   'dictKey' : "MbLoader",         'cssClass' : "mbId",    'showOnHome' : True,  'renderSideBar' : False, 'genRow' : True,  'type' : 'Manga-defunct' },
		...
		{'dbKey' : None,      'name' : "MU Mon",      'dictKey' : "BuMon",            'cssClass' : "buId",    'showOnHome' : False, 'renderSideBar' : True,  'genRow' : False, 'type' : 'Info'          },
		...
		############################################################################# ##########################
		{'dbKey' : None,      'name' : "Mt Mon",      'dictKey' : False,              'cssClass' : "mtMonId", 'showOnHome' : True,  'renderSideBar' : True,  'genRow' : False, 'type' : 'Manga-defunct' },
		############################################################################# ##########################
