...
import settings
import urllib.parse
import MangaCMS.web.apiHandler

import MangaCMS.web.sessionManager
...
class PageResource(object):
	...
	def __init__(self):
		...
		self.session_pool = MangaCMS.web.sessionManager.SessionPoolManager()
		self.apiInterface = MangaCMS.web.apiHandler.ApiInterface(self.conn)
